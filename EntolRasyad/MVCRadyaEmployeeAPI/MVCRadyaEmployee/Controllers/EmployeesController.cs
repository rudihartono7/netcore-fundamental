...
namespace MVCRadyaEmployee.Controllers
{
    ...
    public class EmployeesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EmployeeID,Name,City,Position,CompanyID")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmployeeID,Name,City,Position,CompanyID")] Employee employee)
        {
